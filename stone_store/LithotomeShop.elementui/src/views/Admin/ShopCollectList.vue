    ...
    <div class="app-container">
        <el-card class="box-card">            
            <div slot="header" class="clearfix">
                ...
                <el-button @click="ResetClick" icon="el-icon-delete">重 置</el-button>
            </div>
            <div class="tb-body">
        ...
        <el-dialog  :title="formData.Id ? '修改店铺收藏' : '添加店铺收藏'"   :visible.sync="editorShow" width="50%" :lock-scroll="true" height="800px">
            <el-form v-if="editorShow == true" ref="editModalForm" :rules="editModalFormRules" :model="formData"
                label-width="140px" size="mini">
                 <el-row :gutter="10" class="EditFromBody" style="  height: 600px;overflow-y: scroll">
                    <el-col :span="24">
                        <el-form-item label="店铺" prop="ShopId">
                          <SigleSelect url="/Shop/List" columnName="店铺名称" columnValue="Id"  v-model="formData.ShopId" >
                          </SigleSelect>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
        ...
        <PaginationTable ref="PaginationTableId" url="/ShopCollect/List" :column="dataColum">
...
export default {
    ...
    methods: {
        ...
        async UpdateEntityAsync(Id, title, data) {
            let { Data } = await this.$PostSigleUpdate(`/ShopCollect/Get`, `/ShopCollect/CreateOrEdit`, Id, title, data);
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/ShopCollect/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    var { Success } = await this.$Post(`/ShopCollect/CreateOrEdit`, this.formData);
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/ShopCollect/Delete`, { Id: Id });
       		   this.$refs.PaginationTableId.Reload(this.searchForm);
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/ShopCollect/BatchDelete`, { Ids: ids });
