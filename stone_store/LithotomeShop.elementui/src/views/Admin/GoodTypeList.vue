<template>
    <div class="app-container">
        ...
        <el-dialog :title="formData.Id ? '修改石材分类' : '添加石材分类'" :visible.sync="editorShow" width="50%" :lock-scroll="true"
            height="800px">
        ...
        <PaginationTable ref="PaginationTableId" url="/GoodType/List" :column="dataColum" :where="where">
            <template v-slot:header>
                ...
                <el-button type="danger" size="mini" icon="el-icon-delete" @click="ShowBatchDeleteModal()">批 量 删
                    除</el-button>
                <ExportButton :where="searchForm" exportUrl="/GoodType/Export"></ExportButton>
