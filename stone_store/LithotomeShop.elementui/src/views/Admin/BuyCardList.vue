<template>
    <div class="app-container">
        ...
        <el-dialog :title="formData.Id ? '修改购物车' : '添加购物车'" :visible.sync="editorShow" width="50%" :lock-scroll="true"
            height="800px">
        ...
        <PaginationTable ref="PaginationTableId" url="/BuyCard/List" :column="dataColum">
...
export default {
    ...
    methods: {
        ...
        async UpdateEntityAsync(Id, title, data) {
            let { Data } = await this.$PostSigleUpdate(`/BuyCard/Get`, `/BuyCard/CreateOrEdit`, Id, title, data);
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    var { Success } = await this.$Post(`/BuyCard/CreateOrEdit`, this.formData);
