...
<template>
    <div class="app-container">
            ...
            <div class="tb-body">
                <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
                    ...
                    <el-form-item label="文章分类">
                        <SigleSelect url="/ArticleType/List" columnName="Name" :clearable="true" columnValue="Id"
        ...
        <el-dialog :title="formData.Id ? '修改文章' : '添加文章'" :visible.sync="editorShow" width="50%" :lock-scroll="true"
            height="800px">
                ...
                <el-row :gutter="10" class="EditFromBody">
                    ...
                    <el-col :span="24">
                        <el-form-item label="文章分类" prop="ArticleTypeId">
                            <SigleSelect url="/ArticleType/List" columnName="Name" columnValue="Id"
        ...
        <PaginationTable ref="PaginationTableId" url="/Article/List" :column="dataColum" :where="where">
...
export default {
    ...
    methods: {
        ...
        async UpdateEntityAsync(Id, title, data) {
            let { Data } = await this.$PostSigleUpdate(`/Article/Get`, `/Article/CreateOrEdit`, Id, title, data);
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/Article/Get`, { Id: Id });
            if (!Id) {
                Data.ReadCount = 0;
            }
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    var { Success } = await this.$Post(`/Article/CreateOrEdit`, this.formData);
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/Article/Delete`, { Id: Id });
            this.$refs.PaginationTableId.Reload(this.searchForm);
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/Article/BatchDelete`, { Ids: ids });
