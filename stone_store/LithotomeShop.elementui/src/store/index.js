...
import { getToken, removeToken, setToken } from "@/utils/cache.js";
import Vue from "vue";
...
const store = new Vuex.Store({
  ...
  getters: {
    ...
    ShopId: (state) =>
      state.UserInfo && state.UserInfo.ShopDto && state.UserInfo.ShopDto.Id,
    ShopDto: (state) => state.UserInfo && state.UserInfo.ShopDto,
  },
});
